...
struct MPU
{
  ...
  {
    using ENABLE = MPU_MPU_CTRL_ENABLE_Values<MPU::MPU_CTRL, 0, 1, ReadWriteMode, MPUMPU_CTRLBase> ;
    using HFNMIENA = MPU_MPU_CTRL_HFNMIENA_Values<MPU::MPU_CTRL, 1, 1, ReadWriteMode, MPUMPU_CTRLBase> ;
    using PRIVDEFENA = MPU_MPU_CTRL_PRIVDEFENA_Values<MPU::MPU_CTRL, 2, 1, ReadWriteMode, MPUMPU_CTRLBase> ;
    using FieldValues = MPU_MPU_CTRL_PRIVDEFENA_Values<MPU::MPU_CTRL, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using MPU_CTRLPack  = Register<0xE000ED94, 32, ReadWriteMode, MPUMPU_CTRLBase, T...> ;
