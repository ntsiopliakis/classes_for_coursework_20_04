...
struct RCC
{
  ...
  {
    using PLLSAI2RDY = RCC_CR_PLLSAI2RDY_Values<RCC::CR, 29, 1, ReadMode, RCCCRBase> ;
    using PLLSAI2ON = RCC_CR_PLLSAI2ON_Values<RCC::CR, 28, 1, ReadWriteMode, RCCCRBase> ;
  ...
  struct RCCPLLSAI2CFGRBase {} ;

  struct PLLSAI2CFGR : public RegisterBase<0x40021014, 32, ReadWriteMode>
  {
    using PLLSAI2R = RCC_PLLSAI2CFGR_PLLSAI2R_Values<RCC::PLLSAI2CFGR, 25, 2, ReadWriteMode, RCCPLLSAI2CFGRBase> ;
    using PLLSAI2REN = RCC_PLLSAI2CFGR_PLLSAI2REN_Values<RCC::PLLSAI2CFGR, 24, 1, ReadWriteMode, RCCPLLSAI2CFGRBase> ;
    using PLLSAI2P = RCC_PLLSAI2CFGR_PLLSAI2P_Values<RCC::PLLSAI2CFGR, 17, 1, ReadWriteMode, RCCPLLSAI2CFGRBase> ;
    using PLLSAI2PEN = RCC_PLLSAI2CFGR_PLLSAI2PEN_Values<RCC::PLLSAI2CFGR, 16, 1, ReadWriteMode, RCCPLLSAI2CFGRBase> ;
    using PLLSAI2N = RCC_PLLSAI2CFGR_PLLSAI2N_Values<RCC::PLLSAI2CFGR, 8, 7, ReadWriteMode, RCCPLLSAI2CFGRBase> ;
    using PLLSAI2PDIV = RCC_PLLSAI2CFGR_PLLSAI2PDIV_Values<RCC::PLLSAI2CFGR, 27, 5, ReadWriteMode, RCCPLLSAI2CFGRBase> ;
    using FieldValues = RCC_PLLSAI2CFGR_PLLSAI2PDIV_Values<RCC::PLLSAI2CFGR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using PLLSAI2CFGRPack  = Register<0x40021014, 32, ReadWriteMode, RCCPLLSAI2CFGRBase, T...> ;
  ...
  struct CIER : public RegisterBase<0x40021018, 32, ReadWriteMode>
  {
    ...
    using PLLSAI2RDYIE = RCC_CIER_PLLSAI2RDYIE_Values<RCC::CIER, 7, 1, ReadWriteMode, RCCCIERBase> ;
  ...
  struct CIFR : public RegisterBase<0x4002101C, 32, ReadMode>
  {
    ...
    using PLLSAI2RDYF = RCC_CIFR_PLLSAI2RDYF_Values<RCC::CIFR, 7, 1, ReadMode, RCCCIFRBase> ;
  ...
  struct CICR : public RegisterBase<0x40021020, 32, WriteMode>
  {
    ...
    using PLLSAI2RDYC = RCC_CICR_PLLSAI2RDYC_Values<RCC::CICR, 7, 1, WriteMode, RCCCICRBase> ;
  ...
  struct AHB2RSTR : public RegisterBase<0x4002102C, 32, ReadWriteMode>
  {
    ...
    using GPIOGRST = RCC_AHB2RSTR_GPIOGRST_Values<RCC::AHB2RSTR, 6, 1, ReadWriteMode, RCCAHB2RSTRBase> ;
    using GPIOFRST = RCC_AHB2RSTR_GPIOFRST_Values<RCC::AHB2RSTR, 5, 1, ReadWriteMode, RCCAHB2RSTRBase> ;
  ...
  struct AHB3RSTR : public RegisterBase<0x40021030, 32, ReadWriteMode>
  {
    ...
    using FMCRST = RCC_AHB3RSTR_FMCRST_Values<RCC::AHB3RSTR, 0, 1, ReadWriteMode, RCCAHB3RSTRBase> ;
    using FieldValues = RCC_AHB3RSTR_FMCRST_Values<RCC::AHB3RSTR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct APB1RSTR1 : public RegisterBase<0x40021038, 32, ReadWriteMode>
  {
    ...
    using UART5RST = RCC_APB1RSTR1_UART5RST_Values<RCC::APB1RSTR1, 20, 1, ReadWriteMode, RCCAPB1RSTR1Base> ;
    using UART4RST = RCC_APB1RSTR1_UART4RST_Values<RCC::APB1RSTR1, 19, 1, ReadWriteMode, RCCAPB1RSTR1Base> ;
    using USART3RST = RCC_APB1RSTR1_USART3RST_Values<RCC::APB1RSTR1, 18, 1, ReadWriteMode, RCCAPB1RSTR1Base> ;
    ...
    using TIM5RST = RCC_APB1RSTR1_TIM5RST_Values<RCC::APB1RSTR1, 3, 1, ReadWriteMode, RCCAPB1RSTR1Base> ;
    using TIM4RST = RCC_APB1RSTR1_TIM4RST_Values<RCC::APB1RSTR1, 2, 1, ReadWriteMode, RCCAPB1RSTR1Base> ;
    using TIM3RST = RCC_APB1RSTR1_TIM3RST_Values<RCC::APB1RSTR1, 1, 1, ReadWriteMode, RCCAPB1RSTR1Base> ;
  ...
  struct APB2RSTR : public RegisterBase<0x40021040, 32, ReadWriteMode>
  {
    ...
    using SAI2RST = RCC_APB2RSTR_SAI2RST_Values<RCC::APB2RSTR, 22, 1, ReadWriteMode, RCCAPB2RSTRBase> ;
    ...
    using FieldValues = RCC_APB2RSTR_SYSCFGRST_Values<RCC::APB2RSTR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct AHB2ENR : public RegisterBase<0x4002104C, 32, ReadWriteMode>
  {
    ...
    using GPIOGEN = RCC_AHB2ENR_GPIOGEN_Values<RCC::AHB2ENR, 6, 1, ReadWriteMode, RCCAHB2ENRBase> ;
    using GPIOFEN = RCC_AHB2ENR_GPIOFEN_Values<RCC::AHB2ENR, 5, 1, ReadWriteMode, RCCAHB2ENRBase> ;
  ...
  struct AHB3ENR : public RegisterBase<0x40021050, 32, ReadWriteMode>
  {
    ...
    using FMCEN = RCC_AHB3ENR_FMCEN_Values<RCC::AHB3ENR, 0, 1, ReadWriteMode, RCCAHB3ENRBase> ;
    using FieldValues = RCC_AHB3ENR_FMCEN_Values<RCC::AHB3ENR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct APB1ENR1 : public RegisterBase<0x40021058, 32, ReadWriteMode>
  {
    ...
    using UART5EN = RCC_APB1ENR1_UART5EN_Values<RCC::APB1ENR1, 20, 1, ReadWriteMode, RCCAPB1ENR1Base> ;
    using UART4EN = RCC_APB1ENR1_UART4EN_Values<RCC::APB1ENR1, 19, 1, ReadWriteMode, RCCAPB1ENR1Base> ;
    using USART3EN = RCC_APB1ENR1_USART3EN_Values<RCC::APB1ENR1, 18, 1, ReadWriteMode, RCCAPB1ENR1Base> ;
    ...
    using TIM5EN = RCC_APB1ENR1_TIM5EN_Values<RCC::APB1ENR1, 3, 1, ReadWriteMode, RCCAPB1ENR1Base> ;
    using TIM4EN = RCC_APB1ENR1_TIM4EN_Values<RCC::APB1ENR1, 2, 1, ReadWriteMode, RCCAPB1ENR1Base> ;
    ...
    using FieldValues = RCC_APB1ENR1_CRSEN_Values<RCC::APB1ENR1, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using DFSDM1EN = RCC_APB2ENR_DFSDM1EN_Values<RCC::APB2ENR, 24, 1, ReadWriteMode, RCCAPB2ENRBase> ;
    using SAI2EN = RCC_APB2ENR_SAI2EN_Values<RCC::APB2ENR, 22, 1, ReadWriteMode, RCCAPB2ENRBase> ;
  ...
  struct AHB3SMENR : public RegisterBase<0x40021070, 32, ReadWriteMode>
  {
    ...
    using FMCSMEN = RCC_AHB3SMENR_FMCSMEN_Values<RCC::AHB3SMENR, 0, 1, ReadWriteMode, RCCAHB3SMENRBase> ;
    using FieldValues = RCC_AHB3SMENR_FMCSMEN_Values<RCC::AHB3SMENR, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  struct APB1SMENR1 : public RegisterBase<0x40021078, 32, ReadWriteMode>
  {
    ...
    using UART5SMEN = RCC_APB1SMENR1_UART5SMEN_Values<RCC::APB1SMENR1, 20, 1, ReadWriteMode, RCCAPB1SMENR1Base> ;
    using UART4SMEN = RCC_APB1SMENR1_UART4SMEN_Values<RCC::APB1SMENR1, 19, 1, ReadWriteMode, RCCAPB1SMENR1Base> ;
    using USART3SMEN = RCC_APB1SMENR1_USART3SMEN_Values<RCC::APB1SMENR1, 18, 1, ReadWriteMode, RCCAPB1SMENR1Base> ;
    using USART2SMEN = RCC_APB1SMENR1_USART2SMEN_Values<RCC::APB1SMENR1, 17, 1, ReadWriteMode, RCCAPB1SMENR1Base> ;
    ...
    using TIM5SMEN = RCC_APB1SMENR1_TIM5SMEN_Values<RCC::APB1SMENR1, 3, 1, ReadWriteMode, RCCAPB1SMENR1Base> ;
    using TIM4SMEN = RCC_APB1SMENR1_TIM4SMEN_Values<RCC::APB1SMENR1, 2, 1, ReadWriteMode, RCCAPB1SMENR1Base> ;
    using TIM3SMEN = RCC_APB1SMENR1_TIM3SMEN_Values<RCC::APB1SMENR1, 1, 1, ReadWriteMode, RCCAPB1SMENR1Base> ;
  ...
  {
    using DFSDM1SMEN = RCC_APB2SMENR_DFSDM1SMEN_Values<RCC::APB2SMENR, 24, 1, ReadWriteMode, RCCAPB2SMENRBase> ;
    using SAI2SMEN = RCC_APB2SMENR_SAI2SMEN_Values<RCC::APB2SMENR, 22, 1, ReadWriteMode, RCCAPB2SMENRBase> ;
    ...
    using TIM8SMEN = RCC_APB2SMENR_TIM8SMEN_Values<RCC::APB2SMENR, 13, 1, ReadWriteMode, RCCAPB2SMENRBase> ;
  ...
  {
    using DFSDM1SEL = RCC_CCIPR_DFSDM1SEL_Values<RCC::CCIPR, 31, 1, ReadWriteMode, RCCCCIPRBase> ;
    ...
    using SAI2SEL = RCC_CCIPR_SAI2SEL_Values<RCC::CCIPR, 24, 2, ReadWriteMode, RCCCCIPRBase> ;
    ...
    using UART5SEL = RCC_CCIPR_UART5SEL_Values<RCC::CCIPR, 8, 2, ReadWriteMode, RCCCCIPRBase> ;
    using UART4SEL = RCC_CCIPR_UART4SEL_Values<RCC::CCIPR, 6, 2, ReadWriteMode, RCCCCIPRBase> ;
