...
struct TIM4
{
  ...
  struct DIER : public RegisterBase<0x4000080C, 32, ReadWriteMode>
  {
    ...
    using COMDE = TIM4_DIER_COMDE_Values<TIM4::DIER, 13, 1, ReadWriteMode, TIM4DIERBase> ;
  ...
  struct CCMR1_Input : public RegisterBase<0x40000818, 32, ReadWriteMode>
  {
    ...
    using IC2PSC = TIM4_CCMR1_Input_IC2PSC_Values<TIM4::CCMR1_Input, 10, 2, ReadWriteMode, TIM4CCMR1_InputBase> ;
    ...
    using IC1PSC = TIM4_CCMR1_Input_IC1PSC_Values<TIM4::CCMR1_Input, 2, 2, ReadWriteMode, TIM4CCMR1_InputBase> ;
  ...
  struct OR : public RegisterBase<0x40000850, 32, ReadWriteMode>
  {
    using ETR_RMP = TIM4_OR_ETR_RMP_Values<TIM4::OR, 0, 3, ReadWriteMode, TIM4ORBase> ;
    using TI4_RMP = TIM4_OR_TI4_RMP_Values<TIM4::OR, 3, 2, ReadWriteMode, TIM4ORBase> ;
    using FieldValues = TIM4_OR_TI4_RMP_Values<TIM4::OR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ORPack  = Register<0x40000850, 32, ReadWriteMode, TIM4ORBase, T...> ;
