...
struct GPIOG
{
  ...
  struct MODER : public RegisterBase<0x48001800, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using MODERPack  = Register<0x48001800, 32, ReadWriteMode, GPIOGMODERBase, T...> ;

  struct GPIOGOTYPERBase {} ;

  struct OTYPER : public RegisterBase<0x48001804, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OTYPERPack  = Register<0x48001804, 32, ReadWriteMode, GPIOGOTYPERBase, T...> ;

  struct GPIOGOSPEEDRBase {} ;

  struct OSPEEDR : public RegisterBase<0x48001808, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OSPEEDRPack  = Register<0x48001808, 32, ReadWriteMode, GPIOGOSPEEDRBase, T...> ;

  struct GPIOGPUPDRBase {} ;

  struct PUPDR : public RegisterBase<0x4800180C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using PUPDRPack  = Register<0x4800180C, 32, ReadWriteMode, GPIOGPUPDRBase, T...> ;

  struct GPIOGIDRBase {} ;

  struct IDR : public RegisterBase<0x48001810, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using IDRPack  = Register<0x48001810, 32, ReadMode, GPIOGIDRBase, T...> ;

  struct GPIOGODRBase {} ;

  struct ODR : public RegisterBase<0x48001814, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ODRPack  = Register<0x48001814, 32, ReadWriteMode, GPIOGODRBase, T...> ;

  struct GPIOGBSRRBase {} ;

  struct BSRR : public RegisterBase<0x48001818, 32, WriteMode>
  {
  ...
  template<typename... T> 
  using BSRRPack  = Register<0x48001818, 32, WriteMode, GPIOGBSRRBase, T...> ;

  struct GPIOGLCKRBase {} ;

  struct LCKR : public RegisterBase<0x4800181C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using LCKRPack  = Register<0x4800181C, 32, ReadWriteMode, GPIOGLCKRBase, T...> ;

  struct GPIOGAFRLBase {} ;

  struct AFRL : public RegisterBase<0x48001820, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using AFRLPack  = Register<0x48001820, 32, ReadWriteMode, GPIOGAFRLBase, T...> ;

  struct GPIOGAFRHBase {} ;

  struct AFRH : public RegisterBase<0x48001824, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using AFRHPack  = Register<0x48001824, 32, ReadWriteMode, GPIOGAFRHBase, T...> ;
