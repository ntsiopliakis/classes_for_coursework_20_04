...
struct ADC3
{
  ...
  struct ISR : public RegisterBase<0x50040200, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ISRPack  = Register<0x50040200, 32, ReadWriteMode, ADC3ISRBase, T...> ;

  struct ADC3IERBase {} ;

  struct IER : public RegisterBase<0x50040204, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using IERPack  = Register<0x50040204, 32, ReadWriteMode, ADC3IERBase, T...> ;

  struct ADC3CRBase {} ;

  struct CR : public RegisterBase<0x50040208, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CRPack  = Register<0x50040208, 32, ReadWriteMode, ADC3CRBase, T...> ;

  struct ADC3CFGRBase {} ;

  struct CFGR : public RegisterBase<0x5004020C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CFGRPack  = Register<0x5004020C, 32, ReadWriteMode, ADC3CFGRBase, T...> ;

  struct ADC3CFGR2Base {} ;

  struct CFGR2 : public RegisterBase<0x50040210, 32, ReadWriteMode>
  {
    using ROVSM = ADC3_CFGR2_ROVSM_Values<ADC3::CFGR2, 10, 1, ReadWriteMode, ADC3CFGR2Base> ;
    using TOVS = ADC3_CFGR2_TOVS_Values<ADC3::CFGR2, 9, 1, ReadWriteMode, ADC3CFGR2Base> ;
    using OVSS = ADC3_CFGR2_OVSS_Values<ADC3::CFGR2, 5, 4, ReadWriteMode, ADC3CFGR2Base> ;
    using OVSR = ADC3_CFGR2_OVSR_Values<ADC3::CFGR2, 2, 3, ReadWriteMode, ADC3CFGR2Base> ;
    ...
    using FieldValues = ADC3_CFGR2_ROVSE_Values<ADC3::CFGR2, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CFGR2Pack  = Register<0x50040210, 32, ReadWriteMode, ADC3CFGR2Base, T...> ;

  struct ADC3SMPR1Base {} ;

  struct SMPR1 : public RegisterBase<0x50040214, 32, ReadWriteMode>
  {
    ...
    using SMP0 = ADC3_SMPR1_SMP0_Values<ADC3::SMPR1, 0, 3, ReadWriteMode, ADC3SMPR1Base> ;
    using FieldValues = ADC3_SMPR1_SMP0_Values<ADC3::SMPR1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SMPR1Pack  = Register<0x50040214, 32, ReadWriteMode, ADC3SMPR1Base, T...> ;

  struct ADC3SMPR2Base {} ;

  struct SMPR2 : public RegisterBase<0x50040218, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SMPR2Pack  = Register<0x50040218, 32, ReadWriteMode, ADC3SMPR2Base, T...> ;

  struct ADC3TR1Base {} ;

  struct TR1 : public RegisterBase<0x50040220, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using TR1Pack  = Register<0x50040220, 32, ReadWriteMode, ADC3TR1Base, T...> ;

  struct ADC3TR2Base {} ;

  struct TR2 : public RegisterBase<0x50040224, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using TR2Pack  = Register<0x50040224, 32, ReadWriteMode, ADC3TR2Base, T...> ;

  struct ADC3TR3Base {} ;

  struct TR3 : public RegisterBase<0x50040228, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using TR3Pack  = Register<0x50040228, 32, ReadWriteMode, ADC3TR3Base, T...> ;

  struct ADC3SQR1Base {} ;

  struct SQR1 : public RegisterBase<0x50040230, 32, ReadWriteMode>
  {
    ...
    using L = ADC3_SQR1_L_Values<ADC3::SQR1, 0, 4, ReadWriteMode, ADC3SQR1Base> ;
    using FieldValues = ADC3_SQR1_L_Values<ADC3::SQR1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SQR1Pack  = Register<0x50040230, 32, ReadWriteMode, ADC3SQR1Base, T...> ;

  struct ADC3SQR2Base {} ;

  struct SQR2 : public RegisterBase<0x50040234, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SQR2Pack  = Register<0x50040234, 32, ReadWriteMode, ADC3SQR2Base, T...> ;

  struct ADC3SQR3Base {} ;

  struct SQR3 : public RegisterBase<0x50040238, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SQR3Pack  = Register<0x50040238, 32, ReadWriteMode, ADC3SQR3Base, T...> ;

  struct ADC3SQR4Base {} ;

  struct SQR4 : public RegisterBase<0x5004023C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SQR4Pack  = Register<0x5004023C, 32, ReadWriteMode, ADC3SQR4Base, T...> ;

  struct ADC3DRBase {} ;

  struct DR : public RegisterBase<0x50040240, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using DRPack  = Register<0x50040240, 32, ReadMode, ADC3DRBase, T...> ;

  struct ADC3JSQRBase {} ;

  struct JSQR : public RegisterBase<0x5004024C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using JSQRPack  = Register<0x5004024C, 32, ReadWriteMode, ADC3JSQRBase, T...> ;

  struct ADC3OFR1Base {} ;

  struct OFR1 : public RegisterBase<0x50040260, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OFR1Pack  = Register<0x50040260, 32, ReadWriteMode, ADC3OFR1Base, T...> ;

  struct ADC3OFR2Base {} ;

  struct OFR2 : public RegisterBase<0x50040264, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OFR2Pack  = Register<0x50040264, 32, ReadWriteMode, ADC3OFR2Base, T...> ;

  struct ADC3OFR3Base {} ;

  struct OFR3 : public RegisterBase<0x50040268, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OFR3Pack  = Register<0x50040268, 32, ReadWriteMode, ADC3OFR3Base, T...> ;

  struct ADC3OFR4Base {} ;

  struct OFR4 : public RegisterBase<0x5004026C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OFR4Pack  = Register<0x5004026C, 32, ReadWriteMode, ADC3OFR4Base, T...> ;

  struct ADC3JDR1Base {} ;

  struct JDR1 : public RegisterBase<0x50040280, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using JDR1Pack  = Register<0x50040280, 32, ReadMode, ADC3JDR1Base, T...> ;

  struct ADC3JDR2Base {} ;

  struct JDR2 : public RegisterBase<0x50040284, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using JDR2Pack  = Register<0x50040284, 32, ReadMode, ADC3JDR2Base, T...> ;

  struct ADC3JDR3Base {} ;

  struct JDR3 : public RegisterBase<0x50040288, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using JDR3Pack  = Register<0x50040288, 32, ReadMode, ADC3JDR3Base, T...> ;

  struct ADC3JDR4Base {} ;

  struct JDR4 : public RegisterBase<0x5004028C, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using JDR4Pack  = Register<0x5004028C, 32, ReadMode, ADC3JDR4Base, T...> ;

  struct ADC3AWD2CRBase {} ;

  struct AWD2CR : public RegisterBase<0x500402A0, 32, ReadWriteMode>
  {
    using AWD2CH = ADC3_AWD2CR_AWD2CH_Values<ADC3::AWD2CR, 0, 19, ReadWriteMode, ADC3AWD2CRBase> ;
    using FieldValues = ADC3_AWD2CR_AWD2CH_Values<ADC3::AWD2CR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AWD2CRPack  = Register<0x500402A0, 32, ReadWriteMode, ADC3AWD2CRBase, T...> ;

  struct ADC3AWD3CRBase {} ;

  struct AWD3CR : public RegisterBase<0x500402A4, 32, ReadWriteMode>
  {
    using AWD3CH = ADC3_AWD3CR_AWD3CH_Values<ADC3::AWD3CR, 0, 19, ReadWriteMode, ADC3AWD3CRBase> ;
    using FieldValues = ADC3_AWD3CR_AWD3CH_Values<ADC3::AWD3CR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AWD3CRPack  = Register<0x500402A4, 32, ReadWriteMode, ADC3AWD3CRBase, T...> ;

  struct ADC3DIFSELBase {} ;

  struct DIFSEL : public RegisterBase<0x500402B0, 32, ReadWriteMode>
  {
    using DIFSEL_0 = ADC3_DIFSEL_DIFSEL_0_Values<ADC3::DIFSEL, 0, 1, ReadMode, ADC3DIFSELBase> ;
  ...
  template<typename... T> 
  using DIFSELPack  = Register<0x500402B0, 32, ReadWriteMode, ADC3DIFSELBase, T...> ;

  struct ADC3CALFACTBase {} ;

  struct CALFACT : public RegisterBase<0x500402B4, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CALFACTPack  = Register<0x500402B4, 32, ReadWriteMode, ADC3CALFACTBase, T...> ;
