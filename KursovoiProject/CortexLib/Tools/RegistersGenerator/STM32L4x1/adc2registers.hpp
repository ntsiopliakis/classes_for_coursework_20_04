...
struct ADC2
{
  ...
  struct ISR : public RegisterBase<0x50040100, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using ISRPack  = Register<0x50040100, 32, ReadWriteMode, ADC2ISRBase, T...> ;

  struct ADC2IERBase {} ;

  struct IER : public RegisterBase<0x50040104, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using IERPack  = Register<0x50040104, 32, ReadWriteMode, ADC2IERBase, T...> ;

  struct ADC2CRBase {} ;

  struct CR : public RegisterBase<0x50040108, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CRPack  = Register<0x50040108, 32, ReadWriteMode, ADC2CRBase, T...> ;

  struct ADC2CFGRBase {} ;

  struct CFGR : public RegisterBase<0x5004010C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CFGRPack  = Register<0x5004010C, 32, ReadWriteMode, ADC2CFGRBase, T...> ;

  struct ADC2CFGR2Base {} ;

  struct CFGR2 : public RegisterBase<0x50040110, 32, ReadWriteMode>
  {
    using ROVSM = ADC2_CFGR2_ROVSM_Values<ADC2::CFGR2, 10, 1, ReadWriteMode, ADC2CFGR2Base> ;
    using TOVS = ADC2_CFGR2_TOVS_Values<ADC2::CFGR2, 9, 1, ReadWriteMode, ADC2CFGR2Base> ;
    using OVSS = ADC2_CFGR2_OVSS_Values<ADC2::CFGR2, 5, 4, ReadWriteMode, ADC2CFGR2Base> ;
    using OVSR = ADC2_CFGR2_OVSR_Values<ADC2::CFGR2, 2, 3, ReadWriteMode, ADC2CFGR2Base> ;
    ...
    using FieldValues = ADC2_CFGR2_ROVSE_Values<ADC2::CFGR2, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CFGR2Pack  = Register<0x50040110, 32, ReadWriteMode, ADC2CFGR2Base, T...> ;

  struct ADC2SMPR1Base {} ;

  struct SMPR1 : public RegisterBase<0x50040114, 32, ReadWriteMode>
  {
    ...
    using SMP0 = ADC2_SMPR1_SMP0_Values<ADC2::SMPR1, 0, 3, ReadWriteMode, ADC2SMPR1Base> ;
    using FieldValues = ADC2_SMPR1_SMP0_Values<ADC2::SMPR1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SMPR1Pack  = Register<0x50040114, 32, ReadWriteMode, ADC2SMPR1Base, T...> ;

  struct ADC2SMPR2Base {} ;

  struct SMPR2 : public RegisterBase<0x50040118, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SMPR2Pack  = Register<0x50040118, 32, ReadWriteMode, ADC2SMPR2Base, T...> ;

  struct ADC2TR1Base {} ;

  struct TR1 : public RegisterBase<0x50040120, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using TR1Pack  = Register<0x50040120, 32, ReadWriteMode, ADC2TR1Base, T...> ;

  struct ADC2TR2Base {} ;

  struct TR2 : public RegisterBase<0x50040124, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using TR2Pack  = Register<0x50040124, 32, ReadWriteMode, ADC2TR2Base, T...> ;

  struct ADC2TR3Base {} ;

  struct TR3 : public RegisterBase<0x50040128, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using TR3Pack  = Register<0x50040128, 32, ReadWriteMode, ADC2TR3Base, T...> ;

  struct ADC2SQR1Base {} ;

  struct SQR1 : public RegisterBase<0x50040130, 32, ReadWriteMode>
  {
    ...
    using L = ADC2_SQR1_L_Values<ADC2::SQR1, 0, 4, ReadWriteMode, ADC2SQR1Base> ;
    using FieldValues = ADC2_SQR1_L_Values<ADC2::SQR1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SQR1Pack  = Register<0x50040130, 32, ReadWriteMode, ADC2SQR1Base, T...> ;

  struct ADC2SQR2Base {} ;

  struct SQR2 : public RegisterBase<0x50040134, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SQR2Pack  = Register<0x50040134, 32, ReadWriteMode, ADC2SQR2Base, T...> ;

  struct ADC2SQR3Base {} ;

  struct SQR3 : public RegisterBase<0x50040138, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SQR3Pack  = Register<0x50040138, 32, ReadWriteMode, ADC2SQR3Base, T...> ;

  struct ADC2SQR4Base {} ;

  struct SQR4 : public RegisterBase<0x5004013C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using SQR4Pack  = Register<0x5004013C, 32, ReadWriteMode, ADC2SQR4Base, T...> ;

  struct ADC2DRBase {} ;

  struct DR : public RegisterBase<0x50040140, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using DRPack  = Register<0x50040140, 32, ReadMode, ADC2DRBase, T...> ;

  struct ADC2JSQRBase {} ;

  struct JSQR : public RegisterBase<0x5004014C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using JSQRPack  = Register<0x5004014C, 32, ReadWriteMode, ADC2JSQRBase, T...> ;

  struct ADC2OFR1Base {} ;

  struct OFR1 : public RegisterBase<0x50040160, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OFR1Pack  = Register<0x50040160, 32, ReadWriteMode, ADC2OFR1Base, T...> ;

  struct ADC2OFR2Base {} ;

  struct OFR2 : public RegisterBase<0x50040164, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OFR2Pack  = Register<0x50040164, 32, ReadWriteMode, ADC2OFR2Base, T...> ;

  struct ADC2OFR3Base {} ;

  struct OFR3 : public RegisterBase<0x50040168, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OFR3Pack  = Register<0x50040168, 32, ReadWriteMode, ADC2OFR3Base, T...> ;

  struct ADC2OFR4Base {} ;

  struct OFR4 : public RegisterBase<0x5004016C, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using OFR4Pack  = Register<0x5004016C, 32, ReadWriteMode, ADC2OFR4Base, T...> ;

  struct ADC2JDR1Base {} ;

  struct JDR1 : public RegisterBase<0x50040180, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using JDR1Pack  = Register<0x50040180, 32, ReadMode, ADC2JDR1Base, T...> ;

  struct ADC2JDR2Base {} ;

  struct JDR2 : public RegisterBase<0x50040184, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using JDR2Pack  = Register<0x50040184, 32, ReadMode, ADC2JDR2Base, T...> ;

  struct ADC2JDR3Base {} ;

  struct JDR3 : public RegisterBase<0x50040188, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using JDR3Pack  = Register<0x50040188, 32, ReadMode, ADC2JDR3Base, T...> ;

  struct ADC2JDR4Base {} ;

  struct JDR4 : public RegisterBase<0x5004018C, 32, ReadMode>
  {
  ...
  template<typename... T> 
  using JDR4Pack  = Register<0x5004018C, 32, ReadMode, ADC2JDR4Base, T...> ;

  struct ADC2AWD2CRBase {} ;

  struct AWD2CR : public RegisterBase<0x500401A0, 32, ReadWriteMode>
  {
    using AWD2CH = ADC2_AWD2CR_AWD2CH_Values<ADC2::AWD2CR, 0, 19, ReadWriteMode, ADC2AWD2CRBase> ;
    using FieldValues = ADC2_AWD2CR_AWD2CH_Values<ADC2::AWD2CR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AWD2CRPack  = Register<0x500401A0, 32, ReadWriteMode, ADC2AWD2CRBase, T...> ;

  struct ADC2AWD3CRBase {} ;

  struct AWD3CR : public RegisterBase<0x500401A4, 32, ReadWriteMode>
  {
    using AWD3CH = ADC2_AWD3CR_AWD3CH_Values<ADC2::AWD3CR, 0, 19, ReadWriteMode, ADC2AWD3CRBase> ;
    using FieldValues = ADC2_AWD3CR_AWD3CH_Values<ADC2::AWD3CR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AWD3CRPack  = Register<0x500401A4, 32, ReadWriteMode, ADC2AWD3CRBase, T...> ;

  struct ADC2DIFSELBase {} ;

  struct DIFSEL : public RegisterBase<0x500401B0, 32, ReadWriteMode>
  {
    using DIFSEL_0 = ADC2_DIFSEL_DIFSEL_0_Values<ADC2::DIFSEL, 0, 1, ReadMode, ADC2DIFSELBase> ;
  ...
  template<typename... T> 
  using DIFSELPack  = Register<0x500401B0, 32, ReadWriteMode, ADC2DIFSELBase, T...> ;

  struct ADC2CALFACTBase {} ;

  struct CALFACT : public RegisterBase<0x500401B4, 32, ReadWriteMode>
  {
  ...
  template<typename... T> 
  using CALFACTPack  = Register<0x500401B4, 32, ReadWriteMode, ADC2CALFACTBase, T...> ;
