...
struct UART5
{
  ...
  {
    using M1 = UART5_CR1_M1_Values<UART5::CR1, 28, 1, ReadWriteMode, UART5CR1Base> ;
    ...
    using DEAT4 = UART5_CR1_DEAT4_Values<UART5::CR1, 25, 1, ReadWriteMode, UART5CR1Base> ;
    using DEAT3 = UART5_CR1_DEAT3_Values<UART5::CR1, 24, 1, ReadWriteMode, UART5CR1Base> ;
    using DEAT2 = UART5_CR1_DEAT2_Values<UART5::CR1, 23, 1, ReadWriteMode, UART5CR1Base> ;
    using DEAT1 = UART5_CR1_DEAT1_Values<UART5::CR1, 22, 1, ReadWriteMode, UART5CR1Base> ;
    using DEAT0 = UART5_CR1_DEAT0_Values<UART5::CR1, 21, 1, ReadWriteMode, UART5CR1Base> ;
    using DEDT4 = UART5_CR1_DEDT4_Values<UART5::CR1, 20, 1, ReadWriteMode, UART5CR1Base> ;
    using DEDT3 = UART5_CR1_DEDT3_Values<UART5::CR1, 19, 1, ReadWriteMode, UART5CR1Base> ;
    using DEDT2 = UART5_CR1_DEDT2_Values<UART5::CR1, 18, 1, ReadWriteMode, UART5CR1Base> ;
    using DEDT1 = UART5_CR1_DEDT1_Values<UART5::CR1, 17, 1, ReadWriteMode, UART5CR1Base> ;
    using DEDT0 = UART5_CR1_DEDT0_Values<UART5::CR1, 16, 1, ReadWriteMode, UART5CR1Base> ;
    ...
    using M0 = UART5_CR1_M0_Values<UART5::CR1, 12, 1, ReadWriteMode, UART5CR1Base> ;
  ...
  {
    using ADD4_7 = UART5_CR2_ADD4_7_Values<UART5::CR2, 28, 4, ReadWriteMode, UART5CR2Base> ;
    using ADD0_3 = UART5_CR2_ADD0_3_Values<UART5::CR2, 24, 4, ReadWriteMode, UART5CR2Base> ;
    using RTOEN = UART5_CR2_RTOEN_Values<UART5::CR2, 23, 1, ReadWriteMode, UART5CR2Base> ;
    using ABRMOD1 = UART5_CR2_ABRMOD1_Values<UART5::CR2, 22, 1, ReadWriteMode, UART5CR2Base> ;
    using ABRMOD0 = UART5_CR2_ABRMOD0_Values<UART5::CR2, 21, 1, ReadWriteMode, UART5CR2Base> ;
    ...
    using TAINV = UART5_CR2_TAINV_Values<UART5::CR2, 18, 1, ReadWriteMode, UART5CR2Base> ;
  ...
  struct RQR : public RegisterBase<0x40005018, 32, WriteMode>
  {
    using TXFRQ = UART5_RQR_TXFRQ_Values<UART5::RQR, 4, 1, WriteMode, UART5RQRBase> ;
    using RXFRQ = UART5_RQR_RXFRQ_Values<UART5::RQR, 3, 1, WriteMode, UART5RQRBase> ;
    using MMRQ = UART5_RQR_MMRQ_Values<UART5::RQR, 2, 1, WriteMode, UART5RQRBase> ;
    using SBKRQ = UART5_RQR_SBKRQ_Values<UART5::RQR, 1, 1, WriteMode, UART5RQRBase> ;
    using ABRRQ = UART5_RQR_ABRRQ_Values<UART5::RQR, 0, 1, WriteMode, UART5RQRBase> ;
    using FieldValues = UART5_RQR_ABRRQ_Values<UART5::RQR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using RQRPack  = Register<0x40005018, 32, WriteMode, UART5RQRBase, T...> ;
  ...
  struct ICR : public RegisterBase<0x40005020, 32, WriteMode>
  {
    using WUCF = UART5_ICR_WUCF_Values<UART5::ICR, 20, 1, WriteMode, UART5ICRBase> ;
    using CMCF = UART5_ICR_CMCF_Values<UART5::ICR, 17, 1, WriteMode, UART5ICRBase> ;
    using EOBCF = UART5_ICR_EOBCF_Values<UART5::ICR, 12, 1, WriteMode, UART5ICRBase> ;
    using RTOCF = UART5_ICR_RTOCF_Values<UART5::ICR, 11, 1, WriteMode, UART5ICRBase> ;
    using CTSCF = UART5_ICR_CTSCF_Values<UART5::ICR, 9, 1, WriteMode, UART5ICRBase> ;
    using LBDCF = UART5_ICR_LBDCF_Values<UART5::ICR, 8, 1, WriteMode, UART5ICRBase> ;
    using TCCF = UART5_ICR_TCCF_Values<UART5::ICR, 6, 1, WriteMode, UART5ICRBase> ;
    using IDLECF = UART5_ICR_IDLECF_Values<UART5::ICR, 4, 1, WriteMode, UART5ICRBase> ;
    using ORECF = UART5_ICR_ORECF_Values<UART5::ICR, 3, 1, WriteMode, UART5ICRBase> ;
    using NCF = UART5_ICR_NCF_Values<UART5::ICR, 2, 1, WriteMode, UART5ICRBase> ;
    using FECF = UART5_ICR_FECF_Values<UART5::ICR, 1, 1, WriteMode, UART5ICRBase> ;
    using PECF = UART5_ICR_PECF_Values<UART5::ICR, 0, 1, WriteMode, UART5ICRBase> ;
    using FieldValues = UART5_ICR_PECF_Values<UART5::ICR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using ICRPack  = Register<0x40005020, 32, WriteMode, UART5ICRBase, T...> ;
