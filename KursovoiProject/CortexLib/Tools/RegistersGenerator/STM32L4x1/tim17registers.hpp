...
struct TIM17
{
  ...
  struct DIER : public RegisterBase<0x4001480C, 32, ReadWriteMode>
  {
    ...
    using FieldValues = TIM17_DIER_UIE_Values<TIM17::DIER, 0, 0, NoAccess, NoAccess> ;
  } ;
  ...
  {
    using OC1M_2 = TIM17_CCMR1_Output_OC1M_2_Values<TIM17::CCMR1_Output, 16, 1, ReadWriteMode, TIM17CCMR1_OutputBase> ;
  ...
  struct OR2 : public RegisterBase<0x40014860, 32, ReadWriteMode>
  {
    using BKINE = TIM17_OR2_BKINE_Values<TIM17::OR2, 0, 1, ReadWriteMode, TIM17OR2Base> ;
    using BKCMP1E = TIM17_OR2_BKCMP1E_Values<TIM17::OR2, 1, 1, ReadWriteMode, TIM17OR2Base> ;
    using BKCMP2E = TIM17_OR2_BKCMP2E_Values<TIM17::OR2, 2, 1, ReadWriteMode, TIM17OR2Base> ;
    using BKDFBK1E = TIM17_OR2_BKDFBK1E_Values<TIM17::OR2, 8, 1, ReadWriteMode, TIM17OR2Base> ;
    using BKINP = TIM17_OR2_BKINP_Values<TIM17::OR2, 9, 1, ReadWriteMode, TIM17OR2Base> ;
    using BKCMP1P = TIM17_OR2_BKCMP1P_Values<TIM17::OR2, 10, 1, ReadWriteMode, TIM17OR2Base> ;
    using BKCMP2P = TIM17_OR2_BKCMP2P_Values<TIM17::OR2, 11, 1, ReadWriteMode, TIM17OR2Base> ;
    using FieldValues = TIM17_OR2_BKCMP2P_Values<TIM17::OR2, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using OR2Pack  = Register<0x40014860, 32, ReadWriteMode, TIM17OR2Base, T...> ;
