...
struct TIM5
{
  ...
  struct DIER : public RegisterBase<0x40000C0C, 32, ReadWriteMode>
  {
    ...
    using COMDE = TIM5_DIER_COMDE_Values<TIM5::DIER, 13, 1, ReadWriteMode, TIM5DIERBase> ;
  ...
  struct CCMR1_Input : public RegisterBase<0x40000C18, 32, ReadWriteMode>
  {
    ...
    using IC2PSC = TIM5_CCMR1_Input_IC2PSC_Values<TIM5::CCMR1_Input, 10, 2, ReadWriteMode, TIM5CCMR1_InputBase> ;
    ...
    using IC1PSC = TIM5_CCMR1_Input_IC1PSC_Values<TIM5::CCMR1_Input, 2, 2, ReadWriteMode, TIM5CCMR1_InputBase> ;
  ...
  {
    using ETR_RMP = TIM5_OR_ETR_RMP_Values<TIM5::OR, 0, 3, ReadWriteMode, TIM5ORBase> ;
    using TI4_RMP = TIM5_OR_TI4_RMP_Values<TIM5::OR, 3, 2, ReadWriteMode, TIM5ORBase> ;
    using FieldValues = TIM5_OR_TI4_RMP_Values<TIM5::OR, 0, 0, NoAccess, NoAccess> ;
  } ;
