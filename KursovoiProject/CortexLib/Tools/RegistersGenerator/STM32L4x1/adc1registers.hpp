...
struct ADC1
{
  ...
  template<typename... T> 
  using ISRPack  = Register<0x50040000, 32, ReadWriteMode, ADC1ISRBase, T...> ;
  ...
  template<typename... T> 
  using IERPack  = Register<0x50040004, 32, ReadWriteMode, ADC1IERBase, T...> ;
  ...
  template<typename... T> 
  using CRPack  = Register<0x50040008, 32, ReadWriteMode, ADC1CRBase, T...> ;
  ...
  template<typename... T> 
  using CFGRPack  = Register<0x5004000C, 32, ReadWriteMode, ADC1CFGRBase, T...> ;
  ...
  struct CFGR2 : public RegisterBase<0x50040010, 32, ReadWriteMode>
  {
    ...
    using TOVS = ADC1_CFGR2_TOVS_Values<ADC1::CFGR2, 9, 1, ReadWriteMode, ADC1CFGR2Base> ;
    using OVSS = ADC1_CFGR2_OVSS_Values<ADC1::CFGR2, 5, 4, ReadWriteMode, ADC1CFGR2Base> ;
    using OVSR = ADC1_CFGR2_OVSR_Values<ADC1::CFGR2, 2, 3, ReadWriteMode, ADC1CFGR2Base> ;
    ...
    using FieldValues = ADC1_CFGR2_ROVSE_Values<ADC1::CFGR2, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using CFGR2Pack  = Register<0x50040010, 32, ReadWriteMode, ADC1CFGR2Base, T...> ;
  ...
  struct SMPR1 : public RegisterBase<0x50040014, 32, ReadWriteMode>
  {
    ...
    using SMP0 = ADC1_SMPR1_SMP0_Values<ADC1::SMPR1, 0, 3, ReadWriteMode, ADC1SMPR1Base> ;
    using FieldValues = ADC1_SMPR1_SMP0_Values<ADC1::SMPR1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SMPR1Pack  = Register<0x50040014, 32, ReadWriteMode, ADC1SMPR1Base, T...> ;
  ...
  template<typename... T> 
  using SMPR2Pack  = Register<0x50040018, 32, ReadWriteMode, ADC1SMPR2Base, T...> ;
  ...
  template<typename... T> 
  using TR1Pack  = Register<0x50040020, 32, ReadWriteMode, ADC1TR1Base, T...> ;
  ...
  template<typename... T> 
  using TR2Pack  = Register<0x50040024, 32, ReadWriteMode, ADC1TR2Base, T...> ;
  ...
  template<typename... T> 
  using TR3Pack  = Register<0x50040028, 32, ReadWriteMode, ADC1TR3Base, T...> ;
  ...
  struct SQR1 : public RegisterBase<0x50040030, 32, ReadWriteMode>
  {
    ...
    using L = ADC1_SQR1_L_Values<ADC1::SQR1, 0, 4, ReadWriteMode, ADC1SQR1Base> ;
    using FieldValues = ADC1_SQR1_L_Values<ADC1::SQR1, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using SQR1Pack  = Register<0x50040030, 32, ReadWriteMode, ADC1SQR1Base, T...> ;
  ...
  template<typename... T> 
  using SQR2Pack  = Register<0x50040034, 32, ReadWriteMode, ADC1SQR2Base, T...> ;
  ...
  template<typename... T> 
  using SQR3Pack  = Register<0x50040038, 32, ReadWriteMode, ADC1SQR3Base, T...> ;
  ...
  template<typename... T> 
  using SQR4Pack  = Register<0x5004003C, 32, ReadWriteMode, ADC1SQR4Base, T...> ;
  ...
  template<typename... T> 
  using DRPack  = Register<0x50040040, 32, ReadMode, ADC1DRBase, T...> ;
  ...
  template<typename... T> 
  using JSQRPack  = Register<0x5004004C, 32, ReadWriteMode, ADC1JSQRBase, T...> ;
  ...
  template<typename... T> 
  using OFR1Pack  = Register<0x50040060, 32, ReadWriteMode, ADC1OFR1Base, T...> ;
  ...
  template<typename... T> 
  using OFR2Pack  = Register<0x50040064, 32, ReadWriteMode, ADC1OFR2Base, T...> ;
  ...
  template<typename... T> 
  using OFR3Pack  = Register<0x50040068, 32, ReadWriteMode, ADC1OFR3Base, T...> ;
  ...
  template<typename... T> 
  using OFR4Pack  = Register<0x5004006C, 32, ReadWriteMode, ADC1OFR4Base, T...> ;
  ...
  template<typename... T> 
  using JDR1Pack  = Register<0x50040080, 32, ReadMode, ADC1JDR1Base, T...> ;
  ...
  template<typename... T> 
  using JDR2Pack  = Register<0x50040084, 32, ReadMode, ADC1JDR2Base, T...> ;
  ...
  template<typename... T> 
  using JDR3Pack  = Register<0x50040088, 32, ReadMode, ADC1JDR3Base, T...> ;
  ...
  template<typename... T> 
  using JDR4Pack  = Register<0x5004008C, 32, ReadMode, ADC1JDR4Base, T...> ;

  struct ADC1AWD2CRBase {} ;

  struct AWD2CR : public RegisterBase<0x500400A0, 32, ReadWriteMode>
  {
    using AWD2CH = ADC1_AWD2CR_AWD2CH_Values<ADC1::AWD2CR, 0, 19, ReadWriteMode, ADC1AWD2CRBase> ;
    using FieldValues = ADC1_AWD2CR_AWD2CH_Values<ADC1::AWD2CR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AWD2CRPack  = Register<0x500400A0, 32, ReadWriteMode, ADC1AWD2CRBase, T...> ;

  struct ADC1AWD3CRBase {} ;

  struct AWD3CR : public RegisterBase<0x500400A4, 32, ReadWriteMode>
  {
    using AWD3CH = ADC1_AWD3CR_AWD3CH_Values<ADC1::AWD3CR, 0, 19, ReadWriteMode, ADC1AWD3CRBase> ;
    using FieldValues = ADC1_AWD3CR_AWD3CH_Values<ADC1::AWD3CR, 0, 0, NoAccess, NoAccess> ;
  } ;

  template<typename... T> 
  using AWD3CRPack  = Register<0x500400A4, 32, ReadWriteMode, ADC1AWD3CRBase, T...> ;

  struct ADC1DIFSELBase {} ;

  struct DIFSEL : public RegisterBase<0x500400B0, 32, ReadWriteMode>
  {
    using DIFSEL_0 = ADC1_DIFSEL_DIFSEL_0_Values<ADC1::DIFSEL, 0, 1, ReadMode, ADC1DIFSELBase> ;
  ...
  template<typename... T> 
  using DIFSELPack  = Register<0x500400B0, 32, ReadWriteMode, ADC1DIFSELBase, T...> ;
  ...
  template<typename... T> 
  using CALFACTPack  = Register<0x500400B4, 32, ReadWriteMode, ADC1CALFACTBase, T...> ;
